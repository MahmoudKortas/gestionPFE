...
class ResultatPfe extends StatefulWidget {
  const ResultatPfe({Key? key}) : super(key: key);
  static const routeName = '/ResultatPfe';
  @override
  State<ResultatPfe> createState() => _ResultatPfeState();
}

class _ResultatPfeState extends State<ResultatPfe> {
