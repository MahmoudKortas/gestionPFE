...
class _GererSpecialiteState extends State<GererSpecialite> {
                            ...
                            itemBuilder: (context, index) {
                              return Card(
                                child: ListTile(
                                    ...
                                    // isThreeLine: true,
                                    onTap: () =>
                                        dialog(context, _specialite![index])),
                              );
                            },
                          )
  ...
  Future<String?> dialog(BuildContext context, Specialite specialite) {
    editNomController.text = specialite.nom ?? "";
          ...
          child: Column(
            children: [
              TextFormField(
                decoration: const InputDecoration(
                  prefixIcon: Icon(Icons.description),
                  hintText: 'Saisir nom du specialite',
                ),
                validator: (String? value) {
                  if (value == null || value.isEmpty) {
                    return 'entrez la nom du specialite';
                  }
                  return null;
                },
        ...
        actions: <Widget>[
          ...
          TextButton(
            onPressed: () async {
              ...
              var specialitet;
              specialitet = await ApiSpecialite()
                  .deleteSpecialite(id: specialite.idSpecialite.toString());
              log("_Specialitet::$specialitet");
              getData();
