...
class ProposerSujetEtudiant extends StatefulWidget {
  var fonction;
  var etudiant;
  var encadrant;

  ProposerSujetEtudiant({
    Key? key,
    this.fonction,
    this.encadrant,
    this.etudiant,
  }) : super(key: key);
  static const routeName = '/ProposerSujetEtudiant';
  @override
  State<ProposerSujetEtudiant> createState() => _ProposerSujetEtudiantState();
}

class _ProposerSujetEtudiantState extends State<ProposerSujetEtudiant> {
  // var _sujet;
