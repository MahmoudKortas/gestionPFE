...
class DeposerDocument extends StatefulWidget {
  const DeposerDocument({Key? key}) : super(key: key);
  static const routeName = '/DeposerDocument';
  @override
  State<DeposerDocument> createState() => _DeposerDocumentState();
}

class _DeposerDocumentState extends State<DeposerDocument> {
  var _document;
  var _encadrant;
  var _listeEncadrant = [''];
  var _responsable;
